...
const WhyDoctorKendro = () => {
  const features = [
    {
      id: 1,
      title: 'Verified Doctors',
      desc: '10,000+ Verified Specialists',
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-16 relative z-10">
        ...
        <div className="lg:col-span-5 relative flex justify-center items-center h-[500px] order-1 lg:order-2">
          <div className="relative w-72 h-[480px] bg-white/40 backdrop-blur-2xl rounded-[3rem] border border-white/50 shadow-2xl overflow-hidden group">
            ...
            <div className="absolute top-20 -right-12 bg-white shadow-2xl p-4 rounded-3xl flex items-center gap-3 animate-bounce border border-slate-50">
              <div className="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center text-green-600">
                <ShieldCheck size={20} />
              </div>
              <div>
                <p className="text-[10px] font-black uppercase text-slate-400">Verified</p>
                <p className="text-xs font-bold text-slate-900">10k+ Doctors</p>
              </div>
            </div>

            <div className="absolute bottom-16 -left-16 bg-white/80 backdrop-blur-md shadow-2xl p-5 rounded-[2rem] border border-white/50">
              <div className="flex items-center gap-3 mb-2">
                <div className="w-2 h-2 bg-blue-500 rounded-full animate-ping" />
                <span className="text-[10px] font-bold text-blue-600 uppercase">Live Session</span>
              </div>
              <p className="text-sm font-black text-slate-900 tracking-tight">Dr. Sarah Ahmed</p>
              <p className="text-[10px] text-slate-500 font-medium italic">Joining in 2 mins...</p>
            </div>
          </div>

          <div className="absolute -z-10 w-96 h-96 bg-gradient-to-br from-blue-600/20 to-transparent rounded-full border border-blue-200/20 animate-spin" style={{ animationDuration: '20s' }} />
        </div>
        ...
        <div className="lg:col-span-3 flex flex-col items-center lg:items-end justify-center order-3 space-y-8">
          <div className="bg-white p-8 rounded-[2.5rem] shadow-2xl shadow-blue-900/5 border border-slate-100 flex flex-col items-center group transition-all duration-500 hover:-translate-y-2">
            <div className="w-16 h-16 relative mb-4 bg-slate-100 rounded-full flex items-center justify-center">
          ...
          <button className="flex items-center gap-3 bg-slate-900 text-white px-8 py-4 rounded-2xl font-bold transition-all duration-300 hover:bg-blue-600 hover:shadow-xl group">
            <Smartphone size={20} />
...
export default WhyDoctorKendro