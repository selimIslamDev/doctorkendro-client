...
import {
  ...
  Stethoscope, Wind, Activity, Scissors, Brain, Sparkles,
} from 'lucide-react'
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-16 overflow-hidden">
      ...
      <div className="relative group overflow-hidden">
        ...
        <div className="flex py-6" style={{
          animation: 'marquee-slow 35s linear infinite',
          width: 'max-content',
        }}>
          {infiniteSymptoms.map((symptom, index) => (
            <div key={index} className="flex flex-col items-center mx-6 md:mx-10 group/item cursor-pointer">
              <div className="relative w-24 h-24 mb-5">
                <div className={`w-24 h-24 rounded-full bg-white border border-slate-100 flex items-center justify-center shadow-sm hover:shadow-2xl hover:-translate-y-4 transition-all duration-500 relative z-10 overflow-hidden`}>
