...
const footerData = {
  ...
  cities: [
    "Dhaka", "Chattogram", "Sylhet", "Rajshahi", "Khulna", "Barishal", "Rangpur", "Cumilla"
  ],
  services: [
    ...
    <footer className="bg-[#111827] text-gray-300 pt-16 pb-8">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-6 text-gray-400">
              Find the best doctors and hospitals in Bangladesh. Book appointments and consult online with ease.
            </p>
          ...
          {/* Specialities */}
          <div>
            <h3 className="text-white font-semibold mb-5 uppercase text-xs tracking-wider">Top Specialities</h3>
          ...
          {/* Cities */}
          <div>
            <h3 className="text-white font-semibold mb-5 uppercase text-xs tracking-wider">Doctors in Cities</h3>
            <ul className="space-y-3 text-sm">
              {footerData.cities.map((item) => (
                <li key={item}><Link href="#" className="hover:text-blue-500 transition-colors">Doctors in {item}</Link></li>
              ))}
            </ul>
          </div>
          ...
          {/* Services */}
          <div>
            <h3 className="text-white font-semibold mb-5 uppercase text-xs tracking-wider">Our Services</h3>
            <ul className="space-y-3 text-sm">
          ...
          <div className="hidden lg:block">
            <h3 className="text-white font-semibold mb-5 uppercase text-xs tracking-wider">Company</h3>
            <ul className="space-y-3 text-sm">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex flex-col md:flex-row gap-6 text-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>support@doctokendro.com</span>
            </div>
          </div>

          {/* App Download Buttons (Marham Style) */}
          <div className="flex gap-4">
             <div className="bg-gray-800 px-4 py-2 rounded-lg flex items-center gap-2 cursor-pointer hover:bg-gray-700 transition-colors border border-gray-700">
                <div className="text-xs">Download on the <div className="text-sm font-bold">App Store</div></div>
             </div>
             <div className="bg-gray-800 px-4 py-2 rounded-lg flex items-center gap-2 cursor-pointer hover:bg-gray-700 transition-colors border border-gray-700">
                <div className="text-xs">Get it on <div className="text-sm font-bold">Google Play</div></div>
             </div>
          </div>
        </div>
        ...
        <div className="mt-12 text-center text-xs text-gray-500 border-t border-gray-800 pt-8">
          <p>© {new Date().getFullYear()} DoctoKendro. All rights reserved. Your health, our priority.</p>
        </div>
      </div>
    </footer>
  );
